    ...
    <x-slot name="slot">
        <div class="row">
            ...
            <div class="col s12 m11 l10 grey lighten-3">
                <h1 class="center center-align">Crear Entrada</h1>
                <form action="/entradas" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="import-field">
                        ...
                        <input type="text" name="ENT_DATE" id="ENT_DATE" class="datepicker">
